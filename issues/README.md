...
| ISSUE-08 | 機能要望 | PDF対応 + 索引（back-of-book index）生成 | feature/08-pdf-index | open |
| ISSUE-09 | 機能要望 | 日本語漢字・ひらがな用語の抽出（形態素解析） | feature/09-ja-morphological | open |
| ISSUE-10 | 機能要望 | 日本語サンプルの追加 | feature/10-ja-sample | open |
| ISSUE-11 | 機能要望 | PDFサンプルの追加（ISSUE-08依存） | feature/11-pdf-sample | open |
